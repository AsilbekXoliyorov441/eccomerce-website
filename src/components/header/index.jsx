...
const Header = () => {
  ...
  return (
    <>
      ...
      <ul id="menus-2"
        class="flex sm:hidden bg-[white] flex fixed h-[10vw] w-[100vw] bottom-[0px] justify-between items-center flex py-[30px] px-[30px] z-[900]">
        <li>
          <Link to={""} className="flex flex-col text-[12px] text-[#3D3D4B] items-center">
        ...
        <li>
          <Link to={"filter/name"} className="flex flex-col text-[12px] text-[#3D3D4B] items-center">
      ...
      <div className={`fixed top-0 z-[400] pt-[10px] bg-[white] left-0  w-full h-full ${menus ? "left-0" : "left-[-100%]"}`}>
        ...
        <div className='px-[30px] overflow-y-scroll h-[500  px]'>
          <NavLink
            to="cart"
            className="text-black flex gap-[7px] py-[8px] text-[14px] items-center"
            href=""
          >
